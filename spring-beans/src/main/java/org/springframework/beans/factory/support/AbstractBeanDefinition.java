...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	/**
	 * autowire-candidate 的属性设置为false.这样容器在查找自动装配对象时，将不考虑该bean,即
	 * 它不会被考虑作为其他bean自动装配的候选者，但该bean本身还是可以使用自动装配来注入其他的bean
	 */
	...
	/**
	 * 方法重写的持有者 ，记录Lookup-method、 replaced-method 元索
	 */
	@Nullable
	...
	/**
	 * 是否是用户定义的而不是应用程序本身定义的，创建 AOP 时候为true
	 */
